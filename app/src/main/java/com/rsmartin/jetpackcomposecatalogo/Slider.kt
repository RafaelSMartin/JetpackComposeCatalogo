...
fun AdvanceSlider() {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(text = "Slider position: $sliderPosition")
        Text(text = "Slider position completed: $completeValue")
    }
}
...
fun MyRangeSlider() {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(text = "Slider range inferior: ${currentRange.start}")
        Text(text = "Slider position superior: ${currentRange.endInclusive}")
    }
}